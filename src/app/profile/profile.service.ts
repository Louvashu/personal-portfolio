...
export class ProfileService {
  ...
  projects: any = [
    ...
    },
    {
      ...
      githurl:
        'https://github.com/saitejagoruganthu/-TaskManager_MEANStack_Frontend',
    ...
    },
    {
      ...
      githurl:
        'https://github.com/saitejagoruganthu/Cross-Domain-Enterprise-Online-Market-Place',
...

    {
      ...
      githurl:
        'https://github.com/saitejagoruganthu/Personal-Portfolio-Using-Angular',
...

    {
      ...
      livedemo: '',
      githurl:
        'https://github.com/saitejagoruganthu/CMPE240-Advanced-Computer-Design/tree/main/3D-Graphics-Including-Shading-and-Diffuse-Reflection',
...

    {
      ...
      livedemo: '',
      githurl:
        'https://github.com/saitejagoruganthu/CMPE240-Advanced-Computer-Design/tree/main/2D-Graphics-Rendering-Using-LPC1769',
...

    {
      ...
      livedemo: '',
      githurl:
        'https://github.com/saitejagoruganthu/Hand-Gesture-Controlled-Robot',
  ...
  about2 = `
  Expertise in Angular 2+ all versions along with its material design, Javascript, Nest JS,  Node JS, Express JS, Java. ^
  Have excellent knowledge in Jquery, Bootstrap, MongoDB,PosgreSql, and MySQL. ^
  My interests and extracurricular activities include but not limited to Cricket, Foot-ball and learning new languages.
  `;

  about =
    'I am intuitive in nature, lover of innovation and everything related to generating new knowledge. I tackle problems with a smile and solve them as soon as possible. Very calculative with respect to the time I spend and work I do.';
  resumeurl =
    'https://docs.google.com/document/d/17WDVlslfgW_5-YKQNvFaoD-ZxTBcBgAW/edit?usp=share_link&ouid=117815726226256458495&rtpof=true&sd=true';
